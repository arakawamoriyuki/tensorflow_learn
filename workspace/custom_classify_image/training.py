...
# モデル保存場所
flags.DEFINE_string('model', './models/model.ckpt', 'Directory to put the model.')
...
# TODO: batch_size? len(traning_img)/10?? = もしくは学習率aの事？ = 大きすぎると分散し、小さすぎると学習が遅い
...
if __name__ == '__main__':
    ...
    # print len(train_image) # 1000
    # print len(train_label) # 1000
    # print len(train_image[0]) # 2353
    # print len(train_label[0]) # 10
    # print train_image[0] # 2353 = 28*28*3 = ピクセル数
    # print train_label[0] # [1,0,0...0] = クラスのフラグ
    ...
    with tf.Graph().as_default():
        ...
        index_exists = os.path.isfile('%s.index' % (FLAGS.model))
        meta_exists = os.path.isfile('%s.meta' % (FLAGS.model))
